            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="k8s-input w-full pl-10"
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  onChange={handleChange}
                  className="k8s-input w-full pl-10 pr-10"
                ...
                <button
                  ...
                  className="absolute inset-y-0 right-0 pr-3 flex items-center text-k8s-gray/50 hover:text-k8s-cyan transition-colors"
                  disabled={loading}
                >
